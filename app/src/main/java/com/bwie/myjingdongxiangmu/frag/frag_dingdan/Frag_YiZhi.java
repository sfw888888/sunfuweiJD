...
import com.bwie.myjingdongxiangmu.adapter.MyYiZhiAdapter;
...
public class Frag_YiZhi extends Fragment implements RetrofitView{

    @BindView(R.id.recycler_yizhi)
    RecyclerView recyclerYizhi;
    ...
    private MyYiZhiAdapter adapter;
    ...
    public void myAdapter(){
        if (adapter==null){
            recyclerYizhi.setLayoutManager(new LinearLayoutManager(getActivity()
                    , LinearLayoutManager.VERTICAL,false));
            adapter = new MyYiZhiAdapter(getActivity()
                    , myDataDingDanBean);
            recyclerYizhi.setAdapter(adapter);
        }else {
