...
public class MyLunBoTuTuiJianMiao {
    ...
    public void setTuijian(TuijianEntity tuijian) {
        this.tuijian = tuijian;
    }

    public MiaoshaEntity getMiaosha() {
        return miaosha;
    }

    public void setMiaosha(MiaoshaEntity miaosha) {
